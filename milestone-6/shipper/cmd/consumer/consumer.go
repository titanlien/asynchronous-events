...
import (
	...
	"github.com/bpmericle/Asynchronous-Event-Handling-Using-Microservices-and-Kafka/milestone6/code/db"
	"github.com/bpmericle/Asynchronous-Event-Handling-Using-Microservices-and-Kafka/milestone6/code/events"
	hdlr "github.com/bpmericle/Asynchronous-Event-Handling-Using-Microservices-and-Kafka/milestone6/code/handlers"
	"github.com/bpmericle/Asynchronous-Event-Handling-Using-Microservices-and-Kafka/milestone6/code/metrics"
	"github.com/bpmericle/Asynchronous-Event-Handling-Using-Microservices-and-Kafka/milestone6/code/models"
	"github.com/bpmericle/Asynchronous-Event-Handling-Using-Microservices-and-Kafka/milestone6/code/publisher"
	"github.com/bpmericle/Asynchronous-Event-Handling-Using-Microservices-and-Kafka/milestone6/code/shipper/internal/handlers"
...
func (c *Consumer) SubscribeAndListen() error {
	...
	for {
		...
		// No issues processing the order picked and packed event, lets publish the order time metric
		tag1 := metrics.Tag{
